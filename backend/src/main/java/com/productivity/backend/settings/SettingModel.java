...
public class SettingModel {
    ...
    public Boolean getEmailDigestEnabled() {
    ...
    public List<GridItem> getProfileGridItems() {
        return profileGridItems;
    }

    public void setProfileGridItems(List<GridItem> profileGridItems) {
